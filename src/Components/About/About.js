    ...
    <div className="container">
      <div className="py-4">
        <h2 className="fw-bold">
          Difference between{" "}
          <span className="text-warning">javascript and node.js</span>
        </h2>
        <p>
          ...
          validation, dynamic page display at a set time period, or a simple
      ...
      <div className="py-4">
        <h2 className="fw-bold">
          When should you use <span className="text-warning">node.js?</span>
        </h2>
        <p>
      ...
      <div className="py-4">
        <h2 className="fw-bold">
          When should you <span className="text-warning">use mongodb?</span>
        </h2>
        <p>
      ...
      <div className="py-4">
        <h2 className="fw-bold">
          Difference between{" "}
          <span className="text-warning">sql and nosql?</span>
        </h2>
        <p>
      ...
      <div className="py-4">
        <h2 className="fw-bold">
          ...
          <span className="text-warning"> jwt and how does it work?</span>
        </h2>
        <p>
